...
function ProjectDetailComponent_img_20_Template(rf, ctx) { if (rf & 1) {
...
ProjectDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProjectDetailComponent, selectors: [["app-project-detail"]], decls: 25, vars: 10, consts: [["id", "lead", 1, "project-page-header", "background-alt"], [1, "header-text", 2, "text-align", "center"], [4, "ngIf"], [1, "sub-header-text", 2, "text-align", "center", "margin-top", "48px"], [1, "card-container"], ["class", "card", 4, "ngFor", "ngForOf"], [1, "container", "project-page-contents", 2, "margin-top", "16px"], [1, "row"], ["routerLink", "/", "routerLinkActive", "active", 1, "link-text"], [1, "header-text", 2, "margin-top", "48px"], [1, "body-text"], [1, "header-text", 2, "margin-top", "32px"], [1, "img-responsive", 3, "src"], ["class", "img-responsive", 3, "src", 4, "ngIf"], [1, "card"], [1, "sub-header-text"]], template: function ProjectDetailComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](20, ProjectDetailComponent_img_20_Template, 1, 1, "img", 13);
...
function AchievementHomepageComponent_ng_container_4_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](achievement_r2.description);
} }
function AchievementHomepageComponent_ng_container_4_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](1, AchievementHomepageComponent_ng_container_4_div_1_Template, 8, 3, "div", 4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerEnd"]();
} if (rf & 2) {
...
AchievementHomepageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AchievementHomepageComponent, selectors: [["app-achievement-homepage"]], decls: 5, vars: 2, consts: [["id", "achievements"], [1, "heading"], [4, "ngIf"], [4, "ngFor", "ngForOf"], ["class", "education-block", 4, "ngIf"], [1, "education-block"], [2, "display", "flex", "justify-content", "space-between"], [1, "header-text", 2, "margin-top", "16px", "margin-left", "8px"], [1, "sub-header-text", 2, "margin-top", "16px", "margin-right", "32px"], [1, "body-text", 2, "margin-top", "24px", "margin-left", "8px"]], template: function AchievementHomepageComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "h2", 1);
...
LeadHomepageComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LeadHomepageComponent, selectors: [["app-lead-homepage"]], decls: 16, vars: 3, consts: [["id", "lead"], ["id", "lead-content"], [4, "ngIf"], [2, "color", "white", "font-size", "64px", "font-weight", "bold"], ["target", "blank", 1, "btn-rounded-white", "header-text", 2, "margin-top", "30px", 3, "href"], [1, "bg-circle-1", "bg-circle"], [1, "bg-circle-2", "bg-circle"], [1, "bg-circle-3", "bg-circle"], [1, "bg-circle-4", "bg-circle"], ["id", "lead-down"], [3, "click"], ["aria-hidden", "true", "id", "lead-chevron", 1, "fa", "fa-chevron-down"]], template: function LeadHomepageComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _loader_white_loader_white_component__WEBPACK_IMPORTED_MODULE_3__["LoaderWhiteComponent"]], styles: ["#lead[_ngcontent-%COMP%] {\n  position: relative;\n  overflow: hidden;\n  padding-top: calc(7rem + 72px);\n  padding-bottom: 7rem;\n  background: linear-gradient(0deg, #1d6fa5 0%, #3498db 100%);\n  background-repeat: no-repeat;\n  background-position: center center;\n  background-size: cover;\n  height: 100vh;\n  min-height: 500px;\n  max-height: 600px;\n}\n@media only screen and (max-width: 992px) {\n  #lead[_ngcontent-%COMP%] {\n    height: auto;\n    min-height: auto;\n    max-height: auto;\n    padding: 100px 15px;\n  }\n}\n#lead-content[_ngcontent-%COMP%] {\n  position: absolute;\n  z-index: 10;\n  top: 50%;\n  left: 50%;\n  transform: translate(-50%, -50%);\n  text-align: center;\n}\n#lead-content[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%], #lead-content[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n  margin: 35px;\n}\n#lead-content[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  color: #fff;\n  font-weight: 900;\n  font-size: 5em;\n  text-transform: uppercase;\n  letter-spacing: 0.05em;\n  line-height: 0.9em;\n}\n#lead-content[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n  color: #ccebff;\n  font-weight: 500;\n  font-size: 2.25em;\n  margin-bottom: 15px;\n  line-height: 1.1em;\n}\n@media only screen and (max-width: 992px) {\n  #lead-content[_ngcontent-%COMP%] {\n    position: relative;\n    transform: none;\n    left: auto;\n    top: auto;\n  }\n  #lead-content[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n    font-size: 3em;\n  }\n  #lead-content[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n    font-size: 1.75em;\n  }\n}\n@media only screen and (max-width: 768px) {\n  #lead-content[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n    font-size: 2em;\n  }\n  #lead-content[_ngcontent-%COMP%]   h2[_ngcontent-%COMP%] {\n    font-size: 1.3em;\n  }\n  #lead-content[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n    padding: 10px 20px;\n  }\n}\n@media only screen and (max-width: 480px) {\n  #lead-content[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {\n    font-size: 0.9em;\n    padding: 5px 10px;\n  }\n}\n.bg-circle[_ngcontent-%COMP%] {\n  z-index: 0;\n  position: absolute;\n  border-radius: 100%;\n  background: linear-gradient(0deg, #3498db 0%, #1d6fa5 100%);\n}\n.bg-circle.bg-circle-1[_ngcontent-%COMP%] {\n  height: 100rem;\n  width: 105rem;\n  bottom: -55rem;\n  left: -55rem;\n}\n.bg-circle.bg-circle-2[_ngcontent-%COMP%] {\n  height: 65rem;\n  width: 65rem;\n  top: -25rem;\n  right: -25rem;\n}\n.bg-circle.bg-circle-3[_ngcontent-%COMP%] {\n  height: 40rem;\n  width: 40rem;\n  bottom: -20rem;\n  right: 5%;\n}\n.bg-circle.bg-circle-4[_ngcontent-%COMP%] {\n  height: 46rem;\n  width: 46rem;\n  top: -5rem;\n  right: 35%;\n}\n#lead-down[_ngcontent-%COMP%] {\n  position: absolute;\n  left: 0;\n  right: 0;\n  width: 100%;\n  text-align: center;\n  z-index: 10;\n  bottom: 15px;\n  color: #fff;\n}\n#lead-down[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  cursor: pointer;\n  display: block;\n  margin: 0 auto;\n  width: 35px;\n  height: 35px;\n  border-radius: 50%;\n  border: 3px solid #a0cfee;\n  text-align: center;\n}\n#lead-down[_ngcontent-%COMP%]   i[_ngcontent-%COMP%] {\n  animation: pulsate 1.5s ease;\n  animation-iteration-count: infinite;\n  padding-top: 5px;\n}\n@media only screen and (max-width: 768px) {\n  #lead-down[_ngcontent-%COMP%] {\n    display: none;\n  }\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
function CourseHomepageComponent_ng_container_6_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpropertyInterpolate"]("href", course_r3.time, _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsanitizeUrl"]);
} }
